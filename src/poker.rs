...
pub struct BPFlush { pub rank: Rank }

#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub struct BPStraightFlush { pub rank: Rank }
        ...
        match value {
            &HandValue::StraightFlush(bfsf) => {
                ...
                for top in potential_tops {
                    ...
                    for i in (rank_u8 - 4)..rank_u8 {
                        ...
                        let card = Card { suit: top.suit, rank: rank };
            ...
            &HandValue::Flush(bff) => {
                ...
                for top in &potential_tops {
                    ...
                    for rank in 2..rank_u8 {
                        ...
                        let card = Card { suit: top.suit, rank: rank_card };
                        if self.cards.contains(&card) {
                            total += 1
                        }
                    }
            ...
            &HandValue::Straight(rank) => {
                ...
                for potential_rank in (rank_u8 - 4)..(rank_u8 + 1) {
                    let potential_cards = Card::get_all_with_rank(Rank::from_u8(potential_rank).unwrap());
...
mod test {
    ...
    fn test_contains_high_card() {
        let mut cards = vec!();
        cards.push(Card { rank: Rank::Three, suit: Suit::Diamonds });
        cards.push(Card { rank: Rank::Five, suit: Suit::Clubs });
        cards.push(Card { rank: Rank::Seven, suit: Suit::Clubs });
        cards.push(Card { rank: Rank::Ten, suit: Suit::Hearts });
        cards.push(Card { rank: Rank::Ace, suit: Suit::Spades });
    ...
    fn test_contains_one_pair() {
        ...
        cards.push(Card { rank: Rank::Seven, suit: Suit::Clubs });
        cards.push(Card { rank: Rank::Ten, suit: Suit::Hearts });
        cards.push(Card { rank: Rank::Ten, suit: Suit::Clubs });
        cards.push(Card { rank: Rank::Ace, suit: Suit::Spades });
        let hand = Hand { cards: cards };
    ...
    fn test_contains_two_pair() {
        ...
        cards.push(Card { rank: Rank::Three, suit: Suit::Diamonds });
        cards.push(Card { rank: Rank::Five, suit: Suit::Clubs });
        cards.push(Card { rank: Rank::Five, suit: Suit::Diamonds });
        cards.push(Card { rank: Rank::Ten, suit: Suit::Hearts });
        cards.push(Card { rank: Rank::Ten, suit: Suit::Clubs });
        cards.push(Card { rank: Rank::Ace, suit: Suit::Spades });
        let hand = Hand { cards: cards };
        assert!(hand.contains_handvalue(&HandValue::TwoPair(Rank::Ten, Rank::Five)));
        assert!(!hand.contains_handvalue(&HandValue::TwoPair(Rank::Five, Rank::Ace)));
    }
    #[test]
    fn test_contains_three_of_a_kind() {
        ...
        cards.push(Card { rank: Rank::Five, suit: Suit::Clubs });
        cards.push(Card { rank: Rank::Five, suit: Suit::Diamonds });
        cards.push(Card { rank: Rank::Five, suit: Suit::Hearts });
        cards.push(Card { rank: Rank::Ten, suit: Suit::Clubs });
        cards.push(Card { rank: Rank::Ten, suit: Suit::Spades });
        let hand = Hand { cards: cards };
        assert!(hand.contains_handvalue(&HandValue::ThreeOfAKind(Rank::Five)));
        assert!(!hand.contains_handvalue(&HandValue::ThreeOfAKind(Rank::Ten)));
    }
    #[test]
    fn test_contains_straight() {
        let mut cards = vec!();
        cards.push(Card { rank: Rank::Three, suit: Suit::Diamonds });
        cards.push(Card { rank: Rank::Four, suit: Suit::Clubs });
        cards.push(Card { rank: Rank::Five, suit: Suit::Diamonds });
        cards.push(Card { rank: Rank::Six, suit: Suit::Hearts });
        cards.push(Card { rank: Rank::Seven, suit: Suit::Clubs });
        cards.push(Card { rank: Rank::Eight, suit: Suit::Clubs });
        let hand = Hand { cards: cards };
    ...
    fn test_contains_flush() {
        ...
        cards.push(Card { rank: Rank::Three, suit: Suit::Diamonds });
        cards.push(Card { rank: Rank::Five, suit: Suit::Diamonds });
        cards.push(Card { rank: Rank::Six, suit: Suit::Diamonds });
        cards.push(Card { rank: Rank::Jack, suit: Suit::Diamonds });
        cards.push(Card { rank: Rank::Ace, suit: Suit::Diamonds });
        cards.push(Card { rank: Rank::King, suit: Suit::Clubs });
        cards.push(Card { rank: Rank::Ace, suit: Suit::Clubs });
        let hand = Hand { cards: cards };
        assert!(hand.contains_handvalue(&HandValue::Flush(BPFlush{rank: Rank::Ace})));
        assert!(!hand.contains_handvalue(&HandValue::Flush(BPFlush{rank: Rank::Jack})));
    }
    #[test]
    fn test_contains_full_house() {
        ...
        cards.push(Card { rank: Rank::Ace, suit: Suit::Clubs });
        let hand = Hand { cards: cards };
        assert!(hand.contains_handvalue(&HandValue::FullHouse(Rank::Five, Rank::Ace)));
        assert!(!hand.contains_handvalue(&HandValue::FullHouse(Rank::Ace, Rank::Five)));
    }
    #[test]
    fn test_contains_four_of_a_kind() {
        ...
        cards.push(Card { rank: Rank::Five, suit: Suit::Clubs });
        cards.push(Card { rank: Rank::Five, suit: Suit::Hearts });
        cards.push(Card { rank: Rank::Five, suit: Suit::Spades });
        cards.push(Card { rank: Rank::Ace, suit: Suit::Diamonds });
        cards.push(Card { rank: Rank::Ace, suit: Suit::Spades });
        cards.push(Card { rank: Rank::Ace, suit: Suit::Clubs });
        let hand = Hand { cards: cards };
    ...
    fn test_contains_straight_flush() {
        let mut cards = vec!();
        cards.push(Card { rank: Rank::Ace, suit: Suit::Diamonds });
        cards.push(Card { rank: Rank::King, suit: Suit::Diamonds });
        cards.push(Card { rank: Rank::Queen, suit: Suit::Diamonds });
        cards.push(Card { rank: Rank::Jack, suit: Suit::Diamonds });
        cards.push(Card { rank: Rank::Ten, suit: Suit::Diamonds });
        cards.push(Card { rank: Rank::Nine, suit: Suit::Spades });
        cards.push(Card { rank: Rank::Queen, suit: Suit::Clubs });
        let hand = Hand { cards: cards };
        assert!(hand.contains_handvalue(&HandValue::StraightFlush(BPStraightFlush{rank: Rank::Ace})));
        assert!(!hand.contains_handvalue(&HandValue::StraightFlush(BPStraightFlush{rank: Rank::King})));
    }
    #[test]
